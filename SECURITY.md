...
If you find a vulnerability in `tessera-crewai` or in the way it interacts with the Tessera proxy, please report it privately.
...
- CrewAI core itself -- report there first; we will fast-follow.

## What to include

A clean reproduction is the fastest path to a fix. Please include:

1. Package version (`pip show tessera-crewai`).
2. CrewAI version.
